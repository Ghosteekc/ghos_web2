...
export const api = {
  ...
  getProfile: () => cachedGet<Profile>("profile", "/api/me", TTL.profile),



  getPlayerCollection: () =>

    cachedGet<PlayerCollectionData>("player-collection-v2", "/api/profile/collection", TTL.profile),
  ...
  getStats: () => cachedGet<StatsOverview>("stats", "/api/stats", TTL.stats),
